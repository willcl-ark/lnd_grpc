...
_LOOPOUTREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='sweep_conf_target', full_name='looprpc.LoopOutRequest.sweep_conf_target', index=8,
...
_LOOPINREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='loop_in_channel', full_name='looprpc.LoopInRequest.loop_in_channel', index=3,
...
_SWAPSTATUS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='cost_server', full_name='looprpc.SwapStatus.cost_server', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='cost_onchain', full_name='looprpc.SwapStatus.cost_onchain', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='cost_offchain', full_name='looprpc.SwapStatus.cost_offchain', index=9,
...
_SWAPCLIENT = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002\032\022\030/v1/loop/out/quote/{amt}'),
  ),
  _descriptor.MethodDescriptor(
    name='GetLoopInTerms',
